...
- `<Species>_<cluster_id>_gene_presence_absence_roary.csv`: Gene presence-absence table in Roary format.
- `<Species>_<cluster_id>_gene_presence_absence.Rtab`: Tab-delimited matrix of gene presence.
- `<Species>_<cluster_id>_gene_presence_dist.tsv`: Gene presence-absence distance matrix.
- `<Species>_<cluster_id>_summarystatistics.txt`: Summary statistics for pan-genome analysis.
